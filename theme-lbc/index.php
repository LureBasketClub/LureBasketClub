...
<div id="container">
	...
	<path d="M-865.5,525.4c-2-1.3-7-10.9-8.6-18.2c-1.6-7.4-1-15.4,0-20.4c-4.4-3.1-10.9-2.7-10.9-2.7s0.9,12.8-1.1,17.7
		...
		C-867.6,536.4-865.1,526.9-865.5,525.4z"/>
                        ...
                        <span class="nom-equipe">'.(rwmb_meta("lbc_equipe_1")).'</span>
                    </div>

                    <div class="horaire">
                        <time
                            datetime="'.(rwmb_meta("lbc_heure_debut")).':00">'.(rwmb_meta("lbc_heure_debut")).'</time>
                        <span class="categorie">'.(rwmb_meta("lbc_categorie")).'</span>
                    </div>
	...
	<path d="M-865.5,525.4c-2-1.3-7-10.9-8.6-18.2c-1.6-7.4-1-15.4,0-20.4c-4.4-3.1-10.9-2.7-10.9-2.7s0.9,12.8-1.1,17.7
		...
		C-867.6,536.4-865.1,526.9-865.5,525.4z"/>
                        ...
                        <span class="nom-equipe">'.(rwmb_meta("lbc_equipe_2")).'</span>
                    </div>
                </a>';
            }?>
            <?php endwhile; ?>
                ...
                <a href="<?php the_permalink(); ?>" class="actu">
                    ...
                    <div class="description">
                        <div class="col-1">
                            <h3><?php the_title(); ?></h3>
                            <time
                                datetime="<?php echo(rwmb_meta("lbc_heure")); ?>:00"><?php echo(rwmb_meta("lbc_heure")); ?></time>
                        </div>

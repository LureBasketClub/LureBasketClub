...
<div id="container">
    ...
    <div class="container-match">
        <?php while (have_posts()): the_post(); ?>
            ...
            <div class="container-single-match <?php foreach( $terms as $term ) echo ' ' . $term->slug; ?>">

            <h4 class="date-match"><?php echo date_i18n( ' l d F ',strtotime(rwmb_meta("lbc_date"))); ?></h4>
	...
	<path d="M-865.5,525.4c-2-1.3-7-10.9-8.6-18.2c-1.6-7.4-1-15.4,0-20.4c-4.4-3.1-10.9-2.7-10.9-2.7s0.9,12.8-1.1,17.7
		...
		C-867.6,536.4-865.1,526.9-865.5,525.4z"/>
                    ...
                    <span class="nom-equipe">
                        <?php print_r(rwmb_meta("lbc_equipe_1")); ?>
                    </span>
                </div>

                <div class="horaire">
                    <time>
                        <?php print_r(rwmb_meta("lbc_heure_debut")); ?>
                    </time>
                    <span class="categorie">
                        <?php print_r(rwmb_meta("lbc_categorie")); ?>
                    </span>
                </div>
	...
	<path d="M-865.5,525.4c-2-1.3-7-10.9-8.6-18.2c-1.6-7.4-1-15.4,0-20.4c-4.4-3.1-10.9-2.7-10.9-2.7s0.9,12.8-1.1,17.7
		...
		C-867.6,536.4-865.1,526.9-865.5,525.4z"/>
                    ...
                    <span class="nom-equipe">
                        <?php print_r(rwmb_meta("lbc_equipe_2")); ?>
                    </span>
                </div>
            </a>
            </div>
